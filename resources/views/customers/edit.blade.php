                    ...
                    <form action="{{ route('customer.update', $customer->id) }}" method="POST">
                        ...
                        <fieldset class="border-2 rounded p-6">
                            ...
                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-3">
                                ...
                                <input type="text" name="name" id="name" value="{{ $customer->name }}" class="w-full rounded" required autofocus />
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-3">
                                <label for="email" class="font-semibold">E-mail</label>
                                <input type="email" name="email" id="email" value="{{ $customer->email }}" class="w-full rounded" required autofocus />
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-3">
                                <label for="company" class="font-semibold">Company</label>
                                <input type="text" name="company" id="company" value="{{ $customer->company }}" class="w-full rounded" required autofocus />
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-3">
                                <label for="telephone" class="font-semibold">Telephone</label>
                                <input type="tel" name="telephone" id="telephone" value="{{ $customer->telephone }}" class="w-full rounded" required autofocus />
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-3">
                                <label for="tel_commercial" class="font-semibold">Commercial Contact</label>
                                <input type="tel" name="tel_commercial" id="tel_commercial" value="{{ $customer->tel_commercial }}" class="w-full rounded" required autofocus />
                            </div>

                            <div class="bg-gray-100 p-4 rounded overflow-hidden mb-3">
                                <input type="submit" value="Save" class="bg-blue-500 text-white rounded p-2">
                            </div>
                        </fieldset>
                    </form>
                </div>
